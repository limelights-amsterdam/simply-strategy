...
reading time.
    ...
    python3 {root}/scripts/check_artifact.py runs/<slug>/
    python3 {root}/scripts/check_artifact.py runs/<slug>/simple-strategy-artifact.html
    python3 {root}/scripts/check_artifact.py runs/<slug>/ --json
...
# sits next to this file, so the path holds in a clone and installed alike.
...
# definition is references/flatten/output.md; these are its ids.
SECTIONS = {
