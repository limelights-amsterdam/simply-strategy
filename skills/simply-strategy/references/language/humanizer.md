...
The last pass of step 4. Adapted from the humanizer skill, MIT, see `LICENSE-humanizer`; the
patterns come from Wikipedia's "Signs of AI writing".
...
[humanizer-patterns.md](humanizer-patterns.md), which is where to go when you are actually
...
[humanizer-worked-example.md](humanizer-worked-example.md). Read it once; after that the
